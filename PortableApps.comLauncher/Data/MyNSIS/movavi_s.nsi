...
; === Define constants ===
; **************************************************************************
!define EXEFULLDIR "d:\ThinAppPortable\Captures\Movavi_Video_Suite_21\%ProgramFilesDir%\Movavi Video Suite 21"
!define EXENAME "Suite.exe"
...
!define APPNAME "Movavi Video Suite"				; complete name of program
!define APP "MovaviVideoSuite"					; short name of program without space and accent  this one is used for the final executable an in the directory structure
!define APPEXE "Suite.exe"				; main exe name
!define APPEXE64 "Suite.exe"				; main exe 64 bit name
...
Section "Main"
    ...
    ${If} ${RunningX64}
        SetRegView 64
    ${EndIf}
    ReadRegStr $0 HKCU "Software\Movavi\VideoSuite21" "IsRun"
    ; MessageBox MB_OK "$0"
    ${If} $0 != "1"
        WriteRegStr HKCU "Software\Movavi\VideoSuite21" "autoUpdate" "false"
        WriteRegStr HKCU "Software\Movavi\VideoSuite21" "sendStatistics" "false"
    ${EndIf}
