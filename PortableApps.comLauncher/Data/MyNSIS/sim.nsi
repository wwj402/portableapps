...
; === Define constants ===
; **************************************************************************
!define EXEFULLDIR "d:\SnapShot\sim\Files\@PROGRAMFILESX86@\SIMetrix830\bin"
!define EXENAME "SIMetrix.exe"
!define USERDIR "d:\SnapShot\sim_launcher\Files\@PROGRAMFILESX86@\SIMetrix830"
...
!define APPNAME "SIMetrix SIMPLIS"				; complete name of program
!define APP "SIMetrix SIMPLIS"					; short name of program without space and accent  this one is used for the final executable an in the directory structure
!define APPEXE "bin\SIMetrix.exe"				; main exe name
!define APPEXE64 "bin64\SIMetrix.exe"				; main exe 64 bit name
!define APPDIR "$EXEDIR"				; main exe relative path
!define APPSWITCH 	``
!define LAUNCHERCFG "${APP}launcher.ini"
!define APPPATCH "Patch"
!define USERVER "8.3.x.x"
