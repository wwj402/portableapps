...
; === Define constants ===
; **************************************************************************
!define EXEFULLDIR "d:\SnapShot\abbyyf\Files\@PROGRAMFILESX86@\ABBYY FineReader 15"
!define EXENAME "FineReader.exe"
!define USERDIR "d:\Downloads\ABBYY_all_09.03.2020\ALL_P&F_ABY_09.03.2020\FineReader 15.0.112.2130 Trial, Corporate\FixFiles"
...
!define APPNAME "FineReader"			; complete name of program
!define APP "FineReader"				; short name of program without space and accent  this one is used for the final executable an in the directory structure
!define APPEXE "FineReader.exe"			; main exe name
!define APPEXE64 "FineReader.exe"		; main exe 64 bit name
!define APPDIR "$EXEDIR"				; main exe relative path
!define APPSWITCH 	``
!define LAUNCHERCFG "${APP}launcher.ini"
!define APPPATCH "Patch"
!define USERVER "15.x.x.x"
...
Section "Main"
	...
	; ${SetEnvironmentVariable} VMDIR "$EXEDIR"
	ReadEnvStr $0 VMDIR
