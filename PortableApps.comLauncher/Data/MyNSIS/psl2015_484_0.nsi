...
; === Define constants ===
; **************************************************************************
!define EXEFULLDIR "d:\SnapShot\psl2015base\Files\@PROGRAMFILESX86@\SDL Passolo 2015"
!define EXENAME "psl.exe"
!define USERDIR "$APPDATA\SDL\Passolo 2015"
...
!if ${VER} == "..."
	!undef VER
	!define VER "15.1.484.0"		; version of launcher
!endif
...
!define PSLREGSUB "Software\SDL\Passolo 2015\System"
!define PSLREGNAME "Language"
!define IDFILEDIR "System\DnAutoTranslation"
!define IDFILE "DnAutoTranslation.dll"
